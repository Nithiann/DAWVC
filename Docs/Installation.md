...
$actualHash = (Get-FileHash dawvc-v0.1.0-preview.1-win-x64.zip -Algorithm SHA256).Hash.ToLowerInvariant()
...
```powershell
Expand-Archive -Path dawvc-v0.1.0-preview.1-win-x64.zip -DestinationPath "C:\Tools\dawvc"
```
